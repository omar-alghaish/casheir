...
//             <input type="text" placeholder="ادخل اسم المنتج" />
//           </div>
//           <div className="input_container">
//             <label htmlFor="">الكميه</label>
//             <input type="text" placeholder="ادخل كمية المخزون من المنتج" />
//           </div>
//           <div className="input_container">
//             <label htmlFor="">تاريخ الصلاحيه</label>
//             <div className="inputs_container">
//               <input className="date_input" type="date" placeholder="تاريخ البدء" />
//               <input className="date_input" type="date" placeholder="تاريخ الانتهاء" />
//             </div>
//           </div>
//           <div className="input_container">
//             <label htmlFor="">السعر</label>
//             <input type="text" placeholder="ادخل سعر المنتج الاصلي" />
//           </div>
//           <div className="input_container">
//             <label htmlFor="">الخصم</label>
//             <input type="text" placeholder="ادخل سعر الخصم علي المنتج" />
//           </div>
//           <div className="input_container">
//             <label htmlFor="">سعر الجملة</label>
//             <input type="text" placeholder="ادخل سعر الجمله للمنتج" />
//           </div>
//         </form>
//         <div className="buttons">
//           <button className="save_button">حفظ العملية</button>
//         </div>
//       </div>
//     </div>
//   )
